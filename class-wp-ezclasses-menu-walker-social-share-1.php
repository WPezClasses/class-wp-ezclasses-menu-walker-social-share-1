<?php
/**
 * Class Name: Class_WP_ezClasses_Menu_Walker_Social_Share_1
 * GitHub URI: https://github.com/WPezClasses/class-wp-ezclasses-menu-walker-social-share-1
 * Description: A WP Menu Walker that - along with an icon set (e.g., Font Awesome) - generates a list / menu for sharing to social (a la AddThis, ShareThis, etc).
 * Version: 0.5.3
 * Author:
 * License: MIT
 * License URI: TODO
 ...
 *
 * == v0.5.2 - Fri 22 May 2015
 * --- FORKED: WPezClasses Simple List 1 (
 *
 */
...
class Class_WP_ezClasses_Menu_Walker_Social_Share_1 extends Walker_Nav_Menu {
